...
def create_tables():
   ...
   CREATE TABLE support_messages (
    ...
    subjects = [
        ...
        ('FORMAL LANGUAGE AND AUTOMATA THEORY','CSE',5),
        ('ARTIFICIAL INTELLIGENCE','CSE',5),
        ('SOFTWARE ENGINEERING','CSE',5),
        ('COMPUTER NETWORKS','CSE',6),
        ('MACHINE LEARNING','CSE',6),
        ('PROGRAM ELECTIVE I','CSE',6),
        ('COMPILER DESIGN','CSE',6),
        # (बाकी ece यहाँ)
